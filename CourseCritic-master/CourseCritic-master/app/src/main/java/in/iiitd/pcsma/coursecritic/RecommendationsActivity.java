...
//                    bleh = input.getProgress();
    ...
    /*public void goToContacts(View view) {
        ...
        Intent intent = new Intent(this, ReccotoContacts.class);
...
//    }
    ...
    private class MyOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            TextView textView = (TextView) v.findViewById(R.id.courseCode);
            String courseCodeLocal = textView.getText().toString();
            Intent intent = new Intent(v.getContext(), ReccotoContacts.class);
            System.out.println("Intent is :" + v.getContext());
            intent.putExtra("email", email);
            intent.putExtra("currentCourseCode", courseCodeLocal);
...
//        }
    ...
    public class GetCourseFromDB extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(RecommendationsActivity.this, "Fetching your courses", "Contacting the server. Please wait...", true, false);
